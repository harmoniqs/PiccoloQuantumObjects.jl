...
using ..EmbeddedOperators: AbstractPiccoloOperator

# Re-import DirectTrajOpt constraint types
import DirectTrajOpt: NonlinearKnotPointConstraint, NonlinearGlobalKnotPointConstraint
